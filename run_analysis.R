...
## Combine testing data - xtest, ytest, and subjectTest
##combTest <- cbind(ytest,subjectTest,xtest,body_acc_x_test,body_acc_y_test,body_acc_z_test,body_gyro_x_test, body_gyro_y_test, body_gyro_z_test, total_acc_x_test,total_acc_y_test, total_acc_z_test)
combTest <- cbind(ytest,subjectTest,xtest)


## Combine training data - xtrain, ytrain, subjectTrain and body_acc_xtrain....etc
##combTrain <- cbind(ytrain,subjectTrain,xtrain,body_acc_x_train,body_acc_y_train,body_acc_z_train,body_gyro_x_train, body_gyro_y_train, body_gyro_z_train, total_acc_x_train,total_acc_y_train, total_acc_z_train)
combTrain <- cbind(ytrain,subjectTrain,xtrain)

## Combine testing and training data
combAll <- rbind(combTest,combTrain)

## Transpose features data so to be ready to be used as labels 

names(combAll) <- c("ActivityLabel","UserNumber","tBodyAcc-mean()-X",
"tBodyAcc-mean()-Y",
"tBodyAcc-mean()-Z",
"tBodyAcc-std()-X",
"tBodyAcc-std()-Y",
...
## Only Capture mean and variance
write.table(combAll,"ouput.txt")
